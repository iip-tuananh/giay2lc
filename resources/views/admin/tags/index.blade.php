    ...
    <div ng-controller="tags" ng-cloak>
                ...
                <div class="card p-2">
                    <div class="card-block">
                        <div class="button-tool pb-3 text-right">
                            <a href="javascript:void(0)" class="btn btn-info" data-target="#createModal" data-toggle="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group custom-group">
                                ...
                                <input class="form-control" type="text" ng-model="editing.code"
        ...
        <strong><% errors.name_en[0] %></strong>
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success" ng-disabled="loading"><i class="fa fa-save"></i>
                                Lưu
                            </button>
