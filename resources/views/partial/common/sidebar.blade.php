<div class="sidebar">
 ...
 || request()->is('admin/tags*') || request()->is('admin/tag-groups') ? 'menu-open' : '' }} ">
            ...
            <li class="nav-item has-treeview {{request()->is('admin/about_us') || request()->is('admin/about_us/*') ? 'menu-open' : ''}}">
                <a href="{{route('about_us.edit', 1)}}" class="nav-link {{request()->is('admin/about_us') || request()->is('admin/about_us/*') ? 'active' : ''}}">
