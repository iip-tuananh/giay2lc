                    ...
                    <div class="qrpay-grid">
                        ...
                        <div class="qrpay-col">
                            ...
                            <ul class="qrpay-bank">
                                ...
                                <li><span>Chủ TK:</span><strong>{{ $config->chutaikhoan }}</strong></li>
...
@if(! auth('client')->check())
    <div class="auth-wall" role="dialog" aria-modal="true">
        <div class="auth-card">
            ...
            <div class="auth-actions">
                <a class="btn btn-primary"
                   href="/client/login-client">
                    Đăng nhập
                </a>
                <a class="btn btn-outline" href="{{ route('front.home-page') }}">Về trang chủ</a>
            </div>
        </div>
    </div>
