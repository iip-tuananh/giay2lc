...
use App\Model\Admin\TagGroup as ThisModel;
...
{
    protected $view = 'admin.group_tag';
    protected $route = 'tagGroups';
    ...
    public function searchData(Request $request)
    {
        ...
        return Datatables::of($objects)
            ...
            ->addColumn('tags', function ($object) {
            ...
            ->addColumn('action', function ($object) {
                ...
                $result .= '<a href="'.route('tagGroups.delete', $object->id).'" title="Xóa" class="btn btn-sm btn-danger remove-att"><i class="fas fa-times"></i></a>';
                return $result;
            })
            ->addIndexColumn()
            ->rawColumns(['name','action','tags'])
            ->make(true);
    }
    ...
    public function delete($id)
    {
        ...
        if (!$object->canDelete()) {
            ...
            foreach ($object->tags as $tag) {
                Tagable::query()->where('tag_id', $tag->id)->delete();
            }

            Tag::query()->where('group_id', $object->id)->delete();
