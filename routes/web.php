...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::middleware('auth:admin')->group(function () {
        ...
        Route::group(['prefix' => 'about_us'], function () {
            Route::get('/', 'Admin\AboutUsController@index')->name('about_us.index');
            Route::get('/searchData', 'Admin\AboutUsController@searchData')->name('about_us.searchData');
            Route::get('/{id}/edit', 'Admin\AboutUsController@edit')->name('about_us.edit');
            Route::post('/{id}/update', 'Admin\AboutUsController@update')->name('about_us.update');
        });
